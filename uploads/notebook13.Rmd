...
We also have loaded spatial data about each département in France in the form
of a simply frames object. The data was loaded from a "geojson" file, a
plain-text, open specification for describing spatial data and associated
metadata. Printing out the dataset shows that it is not too different
