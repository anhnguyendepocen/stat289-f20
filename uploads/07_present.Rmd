...
<div class="callbox learn-obj">
<p><b>Learning Objectives</b></p>
<p>After reading this chapter you should be able to:</p>
  <ul>
    <li>Add axis labels and themes to produce a presentation-ready visualization.</li>
    <li>Illustrate the technique of focusing attention as a way of storytelling with data.</li>
  </ul>
</div>
