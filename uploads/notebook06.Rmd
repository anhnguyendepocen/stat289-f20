...
value of the new variable in sequence. For example, here is some code that
produces our new categories:
...
will keep the default value in place. Labels for the x-axis and y-axis will go
on the sides of the plot. Labels for other aesthetics such as size and color
...
categories ordered from largest to smallest. The labels are short so there
should be no need to flip the axes in the plot.
