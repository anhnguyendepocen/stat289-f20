...
Consider the task of taking the cosine of the sine of the square-root of the
logarithm of the number 20. We can compute this in R by nesting each of these
...
The easiest way to understand how we good these elements within **ggplot** is by
seeing an example. Here is the code to specify the data, aes, and geom, along
