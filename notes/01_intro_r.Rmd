...
The previous chapter gives instructions for installing R and RStudio
and obtaining the notebook practice questions associated with these
notes. All of the code that we will work through in these chapters
will be stored as RMarkdown files, which have a `.Rmd` extension. These
files are great because they allow us mix code and descriptions within
the same file.
...
food items were observations.
 ...
 <!-- Jacks, D.S. (2019), "From Boom to Bust: A Typology of Real Commodity
 Prices in the Long Run." Cliometrica 13(2), 202-220. -->
...
There is one exercise notebook for this chapter (the code file is found in the
course materials download zip file)

- **notebook01a.Rmd**: practice running code in RStudio, reading data, and loading packages

It is strongly recommended to complete this notebook prior to continuing on to
the next chapter.

Other useful references for more information include:
...
For those looking for a low-level, programatic introduction to the core
R language, I recommend W. N. Venables' classic, and freely available, notes
titled [An Introduction to R](https://cran.r-project.org/doc/manuals/r-release/R-intro.pdf).
