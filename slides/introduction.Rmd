...
1. Name, year, and (intended) major(s)
2. Academic  
3. Fun fact.
...
- Include preferred pronouns in your Zoom profile (hint: add to the last name field).
- Be prepared to share screen if called on.
- Generally recommended to leave camera off.
...
scheduled for a short oral examination towards the end of the semester. The grading
weighting becomes, instead:
...
the first week of the semester. You will have a chance to select this option at the end of
today's class.
